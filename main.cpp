...
int main()
{
    ...
    while (true)
    {
        cout << "Welcome one and all to a round of Rock, Paper, Scissors, Lizard, Spock! (Enter R, P, S, L, or O)"
             << endl;
        cout << "Player 1: ";
    ...
    cout << "You won " << playerWins << " game(s), lost " << computerWins << " game(s), and tied " << ties << " game(s).";
